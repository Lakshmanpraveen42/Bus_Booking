...
const BusCard = ({ bus, onSelect }) => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-100 dark:border-slate-800 shadow-sm hover:shadow-md transition-shadow mb-4 overflow-hidden">
      <div className="p-6 flex flex-col md:flex-row items-start justify-between gap-6">
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="inline-block px-3 py-1 bg-slate-100 dark:bg-slate-800 rounded text-[10px] font-bold text-slate-600 dark:text-slate-400 uppercase tracking-wider">
             New Bus
          </div>
        </div>
        ...
        <div className="flex-[1.5] w-full flex items-start gap-4">
           <div className="flex-1 text-center">
              <p className="text-lg font-black text-slate-900 dark:text-slate-100 tracking-tight">{bus.departureTime}</p>
           ...
           <div className="flex-1 text-center">
              <p className="text-lg font-black text-slate-900 dark:text-slate-100 tracking-tight">{bus.arrivalTime}</p>
      ...
      <div className="px-6 py-3 bg-slate-50/50 dark:bg-slate-800/50 border-t border-slate-50 dark:border-slate-800 flex items-center gap-6">
